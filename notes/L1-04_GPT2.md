...
| 案情要素 | 内容 |
|---|---|
| **案发时间** | 2019-02（Radford et al., OpenAI 技术报告） · [📄 GPT-2 PDF](https://cdn.openai.com/better-language-models/language_models_are_unsupervised_multitask_learners.pdf) |
...
> 💡 **第 1 条（Pre-LN）后来成为所有现代 LLM 标配**——参见 [L1-09 LayerNorm](notes/L1-09_LayerNorm.md)。
...
这张图直接催生了一年后的 [L2-01 Scaling Laws](notes/L2-01_Scaling_Laws.md) —— *"那继续放大会发生什么？"*
...
### 前置依赖
- 📚 [L1-01 Attention Is All You Need](notes/L1-01_Attention_Is_All_You_Need.md)（架构基础）
- 📚 [L1-03 GPT-1](notes/L1-03_GPT1.md)（半人马式预训练-微调）
- 📚 [L1-09 LayerNorm](notes/L1-09_LayerNorm.md)（GPT-2 引入 Pre-LN）

### 后续推荐
- 🎯 [L2-01 Scaling Laws](notes/L2-01_Scaling_Laws.md)（GPT-2 的趋势变成定律）
- 🎯 [L1-11 GPT-3](notes/L1-11_GPT3.md)（直系后继：175B + few-shot）
- 🎯 [L1-12 Chain of Thought](notes/L1-12_Chain_of_Thought.md)（零样本演化的下一站）
- 🎯 [L1-17 LLaMA](notes/L1-17_LLaMA.md)（GPT-2 思路的开源接班人）
...
| 上次更新 | 2026-05-01 |
| 下一站 | → [L1-05 Neural Machine Translation](notes/L1-05_Neural_Machine_Translation.md) |
